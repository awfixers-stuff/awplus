...
CreatingProgramWith::
  ...
  options: {"types":["*"],"watch":true,"extendedDiagnostics":true,"configFilePath":"/user/username/projects/myproject/tsconfig.json"}
...
[91merror[0m[90m TS2688: [0mCannot find type definition file for 'node'.
  ...
  [96mtsconfig.json[0m:[93m1[0m:[93m34[0m
    [7m1[0m { "compilerOptions": { "types": ["*"] } }
    [7m [0m [96m                                 ~~~[0m
